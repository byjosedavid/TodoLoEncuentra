...
public class Tipo4 extends Abstract {
    ...
    public Tipo4(String nombre, Double precioUnitario, String registroInvima, String fabricante, LocalDate fechaVencimiento, LocalDate fechaFabricacion) {
