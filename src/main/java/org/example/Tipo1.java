...
public class Tipo1 extends Abstract {
    ...
    public Tipo1(String nombre, Double precioUnitario, String registroInvima, String fabricante, LocalDate fechaVencimiento, LocalDate fechaFabricacion) {
