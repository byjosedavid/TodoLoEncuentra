...
public class Tipo3 extends Abstract {
    private Double porcentajeDescuento = 0.08;
    ...
    public Tipo3(String nombre, Double precioUnitario, String registroInvima, String fabricante, LocalDate fechaVencimiento, LocalDate fechaFabricacion) {
