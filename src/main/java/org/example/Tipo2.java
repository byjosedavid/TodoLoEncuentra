...
public class Tipo2 extends Abstract {
    private Double porcentajeDescuento = 0.06;
    ...
    public Tipo2(String nombre, Double precioUnitario, String registroInvima, String fabricante, LocalDate fechaVencimiento, LocalDate fechaFabricacion) {
